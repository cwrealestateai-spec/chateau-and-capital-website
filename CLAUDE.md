...
- Voice: formal, sophisticated, reserved and discreet, confident. Long-term
  language ("decades, not quarters"). **Never use em dashes** in any copy,
  titles or metadata; use commas, colons or semicolons instead. Title
  separator is "|" (e.g. "About | Chateau & Capital").
