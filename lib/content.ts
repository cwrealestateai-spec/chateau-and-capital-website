/*
  ...
  headless CMS later means swapping these exports for fetchers, with no
...
export const insights: Insight[] = [
  ...
  },
  {
    ...
    readTime: "5 min read",
    body: [
      "The most valuable output of an investment process is the deal that never happens. Every filter we operate, from market research and feasibility analysis to reference work and unit-economics reconstruction, exists to make rejection cheap and early.",
